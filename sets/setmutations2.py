...
for n in range(number_of_sets):
    operation,len_new_set = input().split()
...
# print(A)
# A.intersection_update({2, 3, 5, 6, 8, 9, 1, 4, 7, 11})
# print(A)
# A.update({55,66})
# print(A)
# A.symmetric_difference_update({22,7,35,62,58})
# print(A)
# A.difference_update({11,22,35,55,58,62,66})
# print(A)
# print(sum(A))